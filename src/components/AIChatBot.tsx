...
- Cognizant — Jr. Full Stack Developer, Chennai, India (June 2022 – Sep 2023)
...
function getFallbackResponse(question: string): string {
  ...
  if (q.includes('experience') || q.includes('work') || q.includes('company') || q.includes('hcl') || q.includes('infosys')) {
    return "Tarun has 3+ years of experience. He currently works as a Full Stack Developer at HCL America in Dallas (April 2024–Present), and previously worked at Cognizant in Chennai as a Jr. Full Stack Developer (2022–2023).";
  }
